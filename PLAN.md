...
- [ ] 7.0 Archive ordering: append newest sections at bottom (chronological-ascending)
  ...
  - [ ] 7.6 Reconcile renderer: don't double-prefix annotation bullets when the source line already starts with `- `
  - [ ] 7.7 Bridge: id-positional insertion so `7.5a` lands between `7.5` and `7.6` instead of always appending
